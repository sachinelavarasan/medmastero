      ...
      <div className="flex">
        <div className="w-3/5 mt-4">
          <form className="w-full">
            ...
            <div className="flex items-center w-full md:flex-col gap-8 mb-4">
            ...
            {fields.map((branch, index) => (
              <div className="flex flex-col mb-8" key={branch.id}>
                ...
                <div className="relative w-1/2">
                  <Label
                    className="mb-4"
                    variant={errors?.branches?.[index]?.branchAddress?.message ? 'destructive' : 'default'}>
                    Address
                  </Label>
                  <Textarea
