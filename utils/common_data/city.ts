const city = {
    'Andaman and Nicobar Islands': [ { label: 'Port Blair', value: 'Port Blair' } ],
    Haryana: [
    ...
    'Madhya Pradesh': [
      ...
      { label: 'Singrauli'[39m, value: 'Singrauli' },
    ...
    Assam: [
      ...
      { label: 'Mangaldoi'm, value: 'Mangaldoi' },
    ...
    Kerala: [
      ...
      { label: 'Nilambur', value: 'Nilambur'[39m },
    ...
    'Dadra and Nagar Haveli': [ { label: 'Silvassa', value: 'Silvassa' } ],
    Puducherry: [
    ...
    'Uttar Pradesh': [
      ...
      { label: 'SUrban Agglomerationr', value: 'SUrban Agglomerationr' },
    ...
    'Himachal Praddesh': [ { label: 'Manali', value: 'Manali' } ],
    'Arunachal Pradesh': [
